   ...
   /* public function inicio(Request $request){
    ...
    public function store(SolDniPrimeraVezCreateRequest $request){
        ...
        //if($persona){
            ...
            $solicitud->nombre_solicitante=$request->solicitante;
       ...
       // }else{
        //    return redirect()->route('sol-primera.create')->with('notifica','La solicitud No pudo realizarse');
        //}
    }
    ...
    public function edit($id){
        ...
        return view('SolicitudDNI.solPrimera.edit', compact('solicitud','edad','condEdad'));
    }
    ...
    public function review($id){
        ...
        if($edad >20)
            $condEdad='El Ciudadano Sobre pasa la edad para tramite Normal del DNI Azul';
        return view('SolicitudDNI.solPrimera.review', compact('solicitud','edad'))->with('notifica',$condEdad);
    }
