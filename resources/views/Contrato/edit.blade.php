...
@section('contenido')
    <div class="container">
        <div class="shadow-lg py-4 bg-body-tertiary rounded" style="margin-top:8vh">
            <h1 id="titulo" class="acta_title">Editar contrato</h1>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <select name="idTrabajador" id="idTrabajador" class="form-control @error('idTrabajador') is-invalid @enderror"  >
                                            ...
                                            @foreach ($trabajadores as $item)
                                                <option value="{{ $item->DNI}}"
                                                    {{$Contrato->entrevista->postulacion->DNI==$item->DNI?'selected':''}}
                                        ...
                                        @error('idTrabajador')
                                         ...
                                         <input type="text" class="form-control @error('idEntrevista') is-invalid @enderror" value="{{$Contrato->entrevista->idEntrevista}}" id="idEntrevista" 
                                    ...
                                    <div class="row justify-content-center" id="form-new-worker" style="display: none;">
                                        <div class="col-3 form-group">
                                            ...
                                            <input type="text" class="form-control @error('DNI') is-invalid @enderror" value="{{$Contrato->entrevista->Postulacion->DNI}}" id="seguro" 
                                                name="DNI" readonly >
                                            @error('DNI')
                                                <span class="invalid feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                 ...
                                 @endphp
                                    @foreach ($horarios as $item)
                                        ...
                                        <option value="{{ $item->idHorario}}"
                                            {{-- @foreach ($horarios as $item) --}}
                                            {{$Contrato->ContratoHorario->contains('idHorario', $item->idHorario)?'selected':''}}
                                            {{-- @endforeach --}}
                                            
                                            {{-- {{$Contrato->ContratoHorario[1]==$item->idHorario?'selected':''}} --}}
                    ...
                    <div class="tab-pane fade" id="contrato-tab-pane" role="tabpanel" aria-labelledby="contrato-tab" tabindex="0">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-5 form-group">
                                <label class="control-label">Descripción</label>
                                    <textarea  type="text" class="form-control @error('descripcion') is-invalid @enderror"
                                        placeholder="Ingrese descripcion"  name="descripcion" >{{$Contrato->descripcion}}</textarea >
                                @error('descripcion')
                                    <span class="invalid feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-3 form-group">
                                ...
                                <input type="number" class="form-control"  id="diasVacaciones" 
                                    name="diasVacaciones" value={{$Contrato->diasVacaciones}}>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-3 form-group">
                                ...
                                <input type="date" class="form-control"  id="fecha_inicio" 
                                    name="fecha_inicio" value={{$Contrato->fecha_inicio}}>
                                @error('fecha_inicio')
                                    <span class="invalid feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-3 form-group">
                                ...
                                <input type="date" class="form-control" id="fecha_fin" 
                                    name="fecha_fin" value={{$Contrato->fecha_fin}}>
                                @error('fecha_fin')
                                    <span class="invalid feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-2 form-group">
                                ...
                                <input type="text" class="form-control" value={{$Contrato->monto}} id="monto" 
                                    name="monto" >
                                @error('monto')
                                    <span class="invalid feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="row justify-content-center">
                                    ...
                                    <div class="col-8 form-group">
                                        ...
                                        <input type="file" class="form-control @error('contrato') is-invalid @enderror"
                                        placeholder="Ingrese contrato" id="contrato" name="contrato"
                                        x-data="showImage()" @change="showPreview(event)">
                                    @error('contrato')
                                        <span class="invalid feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                                    <iframe id="preview" src="{{$Contrato->archivoContrato}}"  class="object-cover h-32 mt-2 w-60" height="400vh" width="100%" > </iframe>
                                    </div>
                                </div>
