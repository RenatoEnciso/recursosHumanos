...
<body>
    ...
    <header class="hero">
            ...
            <ul class="nav__link nav__link--menu">
                ...
                <li class="nav__items">
                    ...
                    <form action="{{ route('indexT')}}">
                        <button  class="nav__links" style="background-color: transparent;
                        border: none;
                ">
                            Trabajos
                        </button>
        ...
        <section class="hero__container container">
            ...
            <p class="hero__paragraph">Entidad gubernamental encargada de emitir documentos de identificación, como el DNI, y de registrar eventos vitales, como nacimientos y matrimonios, en países como Perú. Su función principal es mantener actualizado el registro civil de la población.</p>
            ...
            <div class="testimony__container container">
                ...
                <section class="testimony__body testimony__body--show" data-id="1">
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Liliana Alexandra, <span class="testimony__course">Directiva de RENIEC</span></h2>
                ...
                <section class="testimony__body" data-id="2">
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Alejandra Perez, <span class="testimony__course">Jefa de RRHH</span></h2>
                        <p class="testimony__review">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est
                ...
                <section class="testimony__body" data-id="3">
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Karen Arteaga, <span class="testimony__course">Practicante de RENIEC</span></h2>
                        <p class="testimony__review">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est
                ...
                <section class="testimony__body" data-id="4">
                    <div class="testimony__texts">
                        <h2 class="subtitle">Mi nombre es Kevin Ramirez, <span class="testimony__course">Encargado de area de TI</span></h2>
                        <p class="testimony__review">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut est
                            esse, niam laboriosam saepe reiciendis dolorem. Cum, ratione voluptatum!</p>
                    </div>
