...
<div class="container">
    ...
    <form method="POST" action="{{route("Solicitud.pago",$Solicitud->idSolicitud)}}">
        @method('PUT')
        @csrf
            ...
            <div class="col-8">
                ...
                <div class="col-12 form-group">
                    ...
                    <select name="DNISolicitante" id="DNISolicitante"
                        class="form-control @error('DNISolicitante') is-invalid @enderror" disabled>
                ...
                <div class="col-12 form-group">
                    ...
                    <select name="idActa[]" id="idActa" multiple="multiple" 
                            class="form-control @error('idActa') is-invalid @enderror" disabled>
                ...
                <div class="col-12 form-group">
                    ...
                    <input type="text" class="form-control @error('observacion') is-invalid @enderror"
                        placeholder="Ingrese Observación" id="observacion" name="observacion" value ={{$Solicitud->observacion}} disabled>
                    @error('observacion')
                        <span class="invalid feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-4">
                <div class="col-12">
                    ...
                    <input type="file" class="form-control @error('archivo') is-invalid @enderror"
                        placeholder="Ingrese Archivo" id="archivo" name="archivo"
                        value="{{ old('archivo') }}" x-data="showImage()" @change="showPreview(event)">
