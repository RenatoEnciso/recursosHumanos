...
@section('titulo', 'Consulta de Tramites rechazados en Consulados')
@section('subtitulo', 'Consulta de Tramites rechazados en Consulados')
@section('cuerpo')
    <form action="{{ route('SearchDefuncion') }}" method="POST" class="px-5 py-2">
        @csrf
        <div>
            <img src="{{ asset('images/consulado.png') }}" alt="consulado" width="100px" class="img-fluid d-block mx-auto">
        </div>
