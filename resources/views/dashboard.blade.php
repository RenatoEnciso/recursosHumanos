    ...
    <body data-background-color="dark">
        ...
        <div class="wrapper">
            <div class="main-header">
                ...
                <div class="logo-header" data-background-color="dark2">
                    ...
                    <a href="{{ route('dashboard') }}" class="logo">
                        <img src="{{ asset('images/Logo-Login.png') }}" alt="navbar brand" class="navbar-brand"
                                            ...
                                            <div class="user-box">
                                                ...
                                                <div class="u-text">
                                                    ...
                                                    <form action="{{ route('usuario.update', Auth::user()->id) }}"
                                                        ...
                                                        @csrf
                                                        <div class="d-flex">
                                                            <label for="archivo" class="bg-success editar_foto">Editar
                                                                foto</label>
                                                            <input type="file" name="file_fotoPerfil"
                                                                style="display: none" id="archivo" class="">
                        ...
                        <ul class="nav nav-primary">
                            ...
                            @if (Auth::user()->idRol == 2)
                                <li class="nav-item">
                                    ...
                                    <div class="collapse" id="solicitudDNI">
                                        <ul class="nav nav-collapse">
                                            <li>
                            ...
                            @if (Auth::user()->idRol == 2)
                                <li class="nav-item">
                                    <a data-toggle="collapse" href="#registroDNI">
                                        <i class="far fa-file-alt"></i>
                                        <p>Registros de DNI azul</p>
                                        <span class="caret"></span>
                                    </a>
                                    <div class="collapse" id="registroDNI">
                                        <ul class="nav nav-collapse">
                                            <li>
                                                <a href="{{ route('reg-primera.index') }}">
                                                    <span class="sub-item">Primera vez</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('reg-duplicado.index') }}">
                                                    <span class="sub-item">Duplicado</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('reg-renovado.index') }}">
                                                    <span class="sub-item">Renovacion</span>
                                                </a>
                                            </li>
            ...
            <div class="main-panel">
                <div class="content">
                    @yield('contenido')
                    <a href="https://wa.me/917700319?text=Me%20gustaría%20obtener%20infor%20precio%20del%20Auto"
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        ...
                        <div class="copyright d-block mx-auto">
                            2022, Hecho <i class="fa fa-heart heart text-danger"></i> por G10-ING. DE
                            REQUERIMIENTOS</a>
                        </div>
                    </div>
                </footer>
                    ...
                    <div class="switcher">
                        <div class="switch-block">
                            ...
                            <div class="btnSwitch">
                                ...
                                <button type="button"
                                    class="selected  changeBackgroundColor changeLogoHeaderColor changeSideBarColor changeTopBarColor"
                                    id="inicio" data-color="white" click></button>
                                <button type="button"
                                    class="changeBackgroundColor changeLogoHeaderColor changeSideBarColor changeTopBarColor"
                        ...
                        <div class="switch-block">
                            ...
                            <div class="btnSwitch">
                                ...
                                <br />
                                <button type="button" class="selected changeLogoHeaderColor" data-color="dark2"
                                    id="inicio1"></button>
                        ...
                        <div class="switch-block">
                            ...
                            <div class="btnSwitch">
                                ...
                                <button type="button" class="selected changeSideBarColor" data-color="dark2"
                                    id="inicio2"></button>
                            </div>
                        </div>
                        <div class="switch-block">
